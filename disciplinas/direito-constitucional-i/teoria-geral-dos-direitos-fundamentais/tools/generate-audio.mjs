...
const python = process.env.DIREITOS_FUNDAMENTAIS_TTS_PYTHON ?? "python3";
const ttsBin = process.env.DIREITOS_FUNDAMENTAIS_TTS_BIN ?? "edge-tts";
const requestedItem = process.env.DIREITOS_FUNDAMENTAIS_TTS_ITEM;
...
for (const item of items) {
  ...
  const args = ["--voice", "pt-BR-AntonioNeural", "--rate=-4%", "--pitch=-12Hz", "--file", textPath, "--write-media", outputPath];
